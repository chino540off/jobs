...
\cventry{}{Antidot}{Search and Content delivery platform for FluidTopics}{}{}{}
\cventry{2023--Today}{Team Manager}{Antidot}{\textit{Lyon}}{}
{
  \begin{itemize}
...
\cventry{2021--Today}{Technical Lead}{Antidot}{\textit{Lyon}}{}
{
  \begin{itemize}
    \renewcommand{\labelitemi}{$\bullet$  }
...
\cventry{2020--Today}{DevOps Engineer}{Antidot}{\textit{Lyon}}{}
{
  \begin{itemize}
    \renewcommand{\labelitemi}{$\bullet$  }
...
\cventry{2019--Today}{Research \& Development Engineer}{Antidot}{\textit{Lyon}}{}
{
  \begin{itemize}
    \renewcommand{\labelitemi}{$\bullet$  }
...
\cventry{2017--2019}{Technical Leader}{Scality}{\textit{Paris}}{}
{
  \begin{itemize}
    \renewcommand{\labelitemi}{$\bullet$  }
...
\section{Skills}
\cvlistitem{\textbf{Advanced DevOps skills}, Massive deployment tools as Ansible or Kubernetes}
\cvlistitem{\textbf{Advanced programming skills in C/C++ for 15 years}, educational and professional projects}
\cvlistitem{\textbf{Advanced network programming skills in the Linux kernel}, mastery of proficient in Linux's network stack}
\cvlistitem{\textbf{Advanced software architecture and design}, network \& distributed system}
\cvlistitem{\textbf{Advanced network and security programming skills}, acquired through project responsibilities in Thales, and Antidot}
...
\cvlistitem{\textbf{Strong network and security design concepts}, taking part of many design task forces to work on
